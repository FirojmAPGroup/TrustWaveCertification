        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-validation">
                    <form id="frmSubAdmin" class="form-valide cls-crud-simple-save" action="{{ routePut('teams.save') }}" method="post">
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label" for="phone">Phone Number <span class="text-danger">*</span>
                                    </label>
                                    <div class="col-lg-6">
                            ...
                            <div class="col-xl-6">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label" for="admin_title"> Title
                                        <span class="text-danger">*</span>
                                    </label>
                                    <div class="col-lg-6">

                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        ...
                                        <p style="font-size:15px; color:#455056; margin:8px 0 0; line-height:24px;">
                                            Your account has been created on the {{ env('APP_NAME') }} Below are your system generated credentials, <br><strong>Please change
                                        ...
                                        <p
                                            ...
                                            <strong
                                                style="display: block;font-size: 13px; margin: 0 0 4px; color:rgba(0,0,0,.64); font-weight:normal;">Username</strong>{{ $user['email'] }}
                                            <strong
                                                style="display: block; font-size: 13px; margin: 24px 0 4px 0; font-weight:normal; color:rgba(0,0,0,.64);">Password</strong>{!! $password  !!}
                                        </p>

                                        <a href="{{ routePut('app.login') }}"
